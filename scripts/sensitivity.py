...
def build_grids() -> dict:
    return {
        ...
        "momentum_lookbacks_d": [
            ...
            ("(14,42,84)",              {"momentum_lookbacks_d": (14, 42, 84)}),
            ("(21,63,126) prior (v3.0)",{"momentum_lookbacks_d": (21, 63, 126)}),
            ("(30,90,180) default",     {"momentum_lookbacks_d": (30, 90, 180)}),
        ...
        "rank_top_n": [
            ...
            ("2",                 {"rank_top_n": 2}),
            ("3 prior (v3.0)",    {"rank_top_n": 3}),
            ("4 default",         {"rank_top_n": 4}),
            ("5",                 {"rank_top_n": 5}),
            ("7",                 {"rank_top_n": 7}),
        ],
        "tier_thresholds": [
